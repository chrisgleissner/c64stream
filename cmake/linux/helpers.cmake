...
function(target_install_resources target)
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/data")
    ...
    list(FILTER data_files EXCLUDE REGEX ".*/scripts/.*\\.expected-trace\\.yaml$")
    ...
    install(
      ...
      PATTERN "scripts/*.expected-trace.yaml" EXCLUDE
    )
...
function(target_add_resource target resource)
  ...
  install(FILES "${resource}" DESTINATION ${CMAKE_INSTALL_DATAROOTDIR}/obs/obs-plugins/${target}/data)

  add_custom_command(
    TARGET ${target}
    POST_BUILD
    COMMAND "${CMAKE_COMMAND}" -E make_directory "${CMAKE_CURRENT_BINARY_DIR}/rundir/$<CONFIG>/${target}/data"
    COMMAND "${CMAKE_COMMAND}" -E copy "${resource}" "${CMAKE_CURRENT_BINARY_DIR}/rundir/$<CONFIG>/${target}/data"
