...
Starts an A/V sync pop generator on a real C64U, then starts OBS, records the incoming stream
and analyses the A/V sync pop offsets in the resulting MP4 recording.
"""
